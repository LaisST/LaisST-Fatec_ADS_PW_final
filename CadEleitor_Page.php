...
<h1  style="text-align:center; color: white" >CADASTRAR ELEITOR</h1>
<form style="color: white" method="post" action="CadEleitor.php" name="dados" onSubmit="return enviardados();">
