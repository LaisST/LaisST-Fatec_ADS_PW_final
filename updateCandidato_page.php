...
<h1  style="text-align:center; color: white" >Atualizar Dados do Candidato</h1>
<form style="color: white" method="post" action="updateCandidato.php" name="dados" onSubmit="return enviardados();">
